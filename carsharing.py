...
#global FastAPI object constructor call
app = FastAPI()
db = [
...
#type hinting used in arguments
@app.get("/api/cars")
...
#path parameter gets input value from url path
@app.get("/api/cars/{id}")
...
#for use with debugging tools inside PyCharm or VSCode IDE
